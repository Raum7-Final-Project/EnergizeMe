...
const LandingPage = () => {
  const STYLE = {
    ...
    contentContainer: `grid grid-rows gap-1 p-4`,
    ...
    Box2: `flex flex-row justify-content pt-1 `,
    Box3: `justify- py-1 px-2 mr-1 mb-1 bg-white rounded-md`,
    Box4: `grid grid-cols-4 gap-3 w-full px-2 pt-1 `,
    Box5: `grid grid-cols-2 gap-3 items-center w-full px-2 pt-1 py-1 mr-2 bg-white rounded-full`,
              ...
              <div className={STYLE.Box5}>
                <li className={STYLE.li}>
                  <div className={STYLE.h4}>
                    <input
                      type="text"
                      placeholder="Suche nach Kategorie, Dauer usw."
